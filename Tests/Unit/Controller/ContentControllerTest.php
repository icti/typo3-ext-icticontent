...
/**
 * Test case for class Tx_Icticontent_Controller_ContentController.
 *
 * @version $Id$
 ...
 */
class Tx_Icticontent_Controller_ContentControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
