...
/**
 * Test case for class Tx_Icticontent_Controller_GeoAreaController.
 *
 * @version $Id$
 ...
 */
class Tx_Icticontent_Controller_GeoAreaControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
