...
/**
 * Test case for class Tx_Icticontent_Controller_ProvinceController.
 *
 * @version $Id$
 ...
 */
class Tx_Icticontent_Controller_ProvinceControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
